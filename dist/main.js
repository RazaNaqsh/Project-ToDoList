/******/ (() => {
  ...
  \*****************************/
			/***/ (
				...
				/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_1__ =
				...
				function taskStatusHandler(e) {
					...
					if (e.target.checked === true) {
						_storage__WEBPACK_IMPORTED_MODULE_1__["default"].inbox[
							taskIndex
						].status = "Complete";
					...
					_localStorage__WEBPACK_IMPORTED_MODULE_0__["default"].updateLocalTodo(
						_storage__WEBPACK_IMPORTED_MODULE_1__["default"].inbox
					);
				...
				function taskCompleteCheck() {
					...
					listItems.forEach((taskItem) => {
						...
						if (
							_storage__WEBPACK_IMPORTED_MODULE_1__["default"].inbox[taskIndex]
								.status === "Complete"
						) {
  ...
  \***************************/
			/***/ (
				...
				/* harmony import */ var _completeTask__WEBPACK_IMPORTED_MODULE_0__ =
					__webpack_require__(/*! ./completeTask */ "./src/completeTask.js");
				...
				/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(/*! ./storage */ "./src/storage.js");
				/* harmony import */ var _task__WEBPACK_IMPORTED_MODULE_3__ =
				...
				function defaultTab() {
					...
					if (localStorage.getItem("todo")) {
						...
						_storage__WEBPACK_IMPORTED_MODULE_2__["default"].inbox =
							localTodoArray;
					}
					_dom__WEBPACK_IMPORTED_MODULE_1__["default"].displayToDom(
						_storage__WEBPACK_IMPORTED_MODULE_2__["default"].inbox
					);
  ...
  \********************/
			/***/ (
				...
				/* harmony import */ var _task__WEBPACK_IMPORTED_MODULE_0__ =
					__webpack_require__(/*! ./task */ "./src/task.js");
				/* harmony import */ var _icons_delete_forever_svg__WEBPACK_IMPORTED_MODULE_1__ =
					__webpack_require__(
						/*! ./icons/delete-forever.svg */ "./src/icons/delete-forever.svg"
					);
				/* harmony import */ var _icons_note_edit_svg__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(
						/*! ./icons/note-edit.svg */ "./src/icons/note-edit.svg"
					);
				/* harmony import */ var _completeTask__WEBPACK_IMPORTED_MODULE_3__ =
					__webpack_require__(/*! ./completeTask */ "./src/completeTask.js");
				/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_4__ =
					__webpack_require__(/*! ./storage */ "./src/storage.js");
				...
				function closeTaskModal(e) {
					...
					document
						.querySelectorAll(".listContainer__listItem")
						.forEach((item) => {
				...
				function domFactory(item, index) {
					...
					if (item.priority === "High")
						divItem.style.borderLeft = "8px solid #dc2626";
					if (item.priority === "Medium")
						divItem.style.borderLeft = "8px solid #fef08a";
					if (item.priority === "Low")
						divItem.style.borderLeft = "8px solid #22c55e";
					...
					showDetails(
						taskDetails,
						_storage__WEBPACK_IMPORTED_MODULE_4__["default"].inbox[index]
					);

					// Edit task
					_task__WEBPACK_IMPORTED_MODULE_0__["default"].editTask(
						editImg,
						_storage__WEBPACK_IMPORTED_MODULE_4__["default"].inbox[index]
					);
				}
				...
				function closeProjectModal(e) {
					const outsideClick =
						...
						!newProjectBtn.contains(e.target);
					if (outsideClick) {
						resetProjectScreen();
					...
					(function dom() {
						function displayToDom(storageArray) {
							storageArray.forEach((item) => {
								domFactory(
									item,
									_storage__WEBPACK_IMPORTED_MODULE_4__[
										"default"
									].inbox.indexOf(item)
								);
							});
							console.log(
								_storage__WEBPACK_IMPORTED_MODULE_4__["default"].inbox
							);
							// storageArray.forEach((item) => {
  ...
  \*********************/
			/***/ (
				...
				/* harmony import */ var _defaultTab__WEBPACK_IMPORTED_MODULE_0__ =
					__webpack_require__(/*! ./defaultTab */ "./src/defaultTab.js");
				...
				/* harmony import */ var _completeTask__WEBPACK_IMPORTED_MODULE_3__ =
					__webpack_require__(/*! ./completeTask */ "./src/completeTask.js");
				/* harmony import */ var _icons_delete_forever_svg__WEBPACK_IMPORTED_MODULE_4__ =
					__webpack_require__(
						/*! ./icons/delete-forever.svg */ "./src/icons/delete-forever.svg"
					);
				/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_5__ =
					__webpack_require__(/*! ./dom */ "./src/dom.js");
				/* harmony import */ var _localStorage__WEBPACK_IMPORTED_MODULE_6__ =
					__webpack_require__(/*! ./localStorage */ "./src/localStorage.js");
				...
				function addLoadEvents(project, projectItem, delImg) {
					project.addEventListener("click", (e) => {
						const outsideDel =
							project.contains(e.target) && !delImg.contains(e.target);
						if (outsideDel) {
							_task__WEBPACK_IMPORTED_MODULE_1__["default"].current(
								projectItem
							);
							_dom__WEBPACK_IMPORTED_MODULE_5__["default"].clearTaskScreen();
							_task__WEBPACK_IMPORTED_MODULE_1__["default"].create();
							const projectPersonalArray =
								_storage__WEBPACK_IMPORTED_MODULE_2__["default"].inbox.filter(
									(item) => item.tab === projectItem
								);
							_dom__WEBPACK_IMPORTED_MODULE_5__["default"].displayToDom(
								projectPersonalArray
							);
							(0, _completeTask__WEBPACK_IMPORTED_MODULE_3__["default"])();
							_dom__WEBPACK_IMPORTED_MODULE_5__["default"].makeProjectActive(
								project
							);
						}
					});
				...
				function addDeleteEvent(delImg) {
					delImg.addEventListener("click", (e) => {
						...
						const domArray = Array.from(
							document.querySelectorAll(".projectTab")
						);
						...
						_localStorage__WEBPACK_IMPORTED_MODULE_6__[
							"default"
						].updateLocalTabs(projectArray);
				...
				function addToArray(e) {
					...
					if (!isEmpty) {
						...
						projectFactory(
							projectItem,
							_storage__WEBPACK_IMPORTED_MODULE_2__["default"].inbox.indexOf(
								projectItem
							)
						);
						// console.log(storage.inbox);
				...
				function tabs() {
					const inboxTab = document.getElementById("defaultTab");
					inboxTab.addEventListener(
						"click",
						_defaultTab__WEBPACK_IMPORTED_MODULE_0__["default"]
					);
  ...
  \*********************/
			/***/ (
				...
				/* harmony import */ var _localStorage__WEBPACK_IMPORTED_MODULE_3__ =
					__webpack_require__(/*! ./localStorage */ "./src/localStorage.js");
				/* harmony import */ var _tabs__WEBPACK_IMPORTED_MODULE_4__ =
					__webpack_require__(/*! ./tabs */ "./src/tabs.js");
				...
				function deleteTasks(div) {
					function deleteFromStorage(e) {
						...
						_storage__WEBPACK_IMPORTED_MODULE_1__["default"].inbox.splice(
							index,
							1
						);
						_dom__WEBPACK_IMPORTED_MODULE_2__["default"].clearTaskScreen();
						if (currentTab === "Inbox")
							_dom__WEBPACK_IMPORTED_MODULE_2__["default"].displayToDom(
								_storage__WEBPACK_IMPORTED_MODULE_1__["default"].inbox
							);
						else
							_dom__WEBPACK_IMPORTED_MODULE_2__["default"].displayToDom(
								_storage__WEBPACK_IMPORTED_MODULE_1__["default"].inbox.filter(
						...
						// console.log(storage.inbox);
						// console.log(index);
						_localStorage__WEBPACK_IMPORTED_MODULE_3__[
							"default"
						].updateLocalTodo(
							_storage__WEBPACK_IMPORTED_MODULE_1__["default"].inbox
						);
				...
				function addToArray(e) {
					...
					if (isEmpty) {
						...
						_storage__WEBPACK_IMPORTED_MODULE_1__["default"].inbox.push(
							taskItem
						);
						_localStorage__WEBPACK_IMPORTED_MODULE_3__[
							"default"
						...
						_dom__WEBPACK_IMPORTED_MODULE_2__["default"].domFactory(
							taskItem,
							_storage__WEBPACK_IMPORTED_MODULE_1__["default"].inbox.indexOf(
								taskItem
							)
						);
						(0, _completeTask__WEBPACK_IMPORTED_MODULE_0__["default"])();
...
*/
  ...
  \**********************/
		__webpack_require__.r(__webpack_exports__);
		/* harmony import */ var _scss_style_scss__WEBPACK_IMPORTED_MODULE_0__ =
			__webpack_require__(/*! ./scss/style.scss */ "./src/scss/style.scss");
		/* harmony import */ var _defaultTab__WEBPACK_IMPORTED_MODULE_1__ =
			__webpack_require__(/*! ./defaultTab */ "./src/defaultTab.js");
		/* harmony import */ var _tabs__WEBPACK_IMPORTED_MODULE_2__ =
			__webpack_require__(/*! ./tabs */ "./src/tabs.js");
