...
*/
  ...
  \*****************************/
			/***/ (
				...
				function taskStatusCheck(e) {
					...
					siblingPara.style.textDecoration = isCompleted
						? "none"
						: "line-through";
  ...
  \***************************/
			/***/ (
				...
				/* harmony import */ var _task__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(/*! ./task */ "./src/task.js");

				function defaultTab() {
					// task.clearTaskScreen();
					_task__WEBPACK_IMPORTED_MODULE_2__["default"].create();
					_task__WEBPACK_IMPORTED_MODULE_2__["default"].displayToDom(
			...
			/***/ (
				...
				function addEvent(project, projectItem) {
					project.addEventListener("click", () => {
						...
						const projectPersonalArray = _storage__WEBPACK_IMPORTED_MODULE_2__[
							"default"
						].inbox.filter((item) => item.tab === projectItem);
						_task__WEBPACK_IMPORTED_MODULE_1__["default"].displayToDom(
  ...
  \**********************/
		...
		/* harmony import */ var _completeTask__WEBPACK_IMPORTED_MODULE_1__ =
			__webpack_require__(/*! ./completeTask */ "./src/completeTask.js");
		/* harmony import */ var _defaultTab__WEBPACK_IMPORTED_MODULE_2__ =
			__webpack_require__(/*! ./defaultTab */ "./src/defaultTab.js");
		/* harmony import */ var _tabs__WEBPACK_IMPORTED_MODULE_3__ =
